...
class carro{
    ...
    public:
    //construtor
    carro(int a, float v, float k); //Deixa apenas o tipo e a variavel (nome e entrada)
    //get e set
    //ano
    void setano(int a);
    int getano();
...
int main(){
    ...
    //construtor
    carro::carro(int a=0, float v=-1, float k=-1){ //O que a funcao realiza e informado aqui, abaixo do main. E necessario colocar o nome da classe seguido de :: (carro::) antes de cada funcao.
        ano = a;
        valor = v;
        km = k;
    }
